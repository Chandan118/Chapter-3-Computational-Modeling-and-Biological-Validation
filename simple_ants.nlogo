...
to go-nest
  face min-one-of patches with [nest?] [distance myself]
  forward 1
...
sed -i "s/simple_ants.nlogo/ant_foraging.nlogo/g" experiment1_runner.py
...
try:
    netlogo.load_model('ant_foraging.nlogo')
    ...
    print(f"✓ TEST PASSED! Food collected: {food}")
